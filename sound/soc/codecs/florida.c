	...
	struct snd_ctl_elem_value *ucontrol)
{
	...
	florida->compr_info[2].freed = value;
	return 0;
}
...
SND_SOC_DAPM_AIF_IN_E("SLIMTX1", NULL, 0,
			ARIZONA_SLIMBUS_TX_CHANNEL_ENABLE,
			ARIZONA_SLIMTX1_ENA_SHIFT, 0,
			arizona_slim_tx_ev,
			SND_SOC_DAPM_POST_PMU | SND_SOC_DAPM_PRE_PMD),
SND_SOC_DAPM_AIF_IN_E("SLIMTX2", NULL, 0,
			ARIZONA_SLIMBUS_TX_CHANNEL_ENABLE,
			ARIZONA_SLIMTX2_ENA_SHIFT, 0,
			arizona_slim_tx_ev,
			SND_SOC_DAPM_POST_PMU | SND_SOC_DAPM_PRE_PMD),
SND_SOC_DAPM_AIF_IN_E("SLIMTX3", NULL, 0,
			ARIZONA_SLIMBUS_TX_CHANNEL_ENABLE,
			ARIZONA_SLIMTX3_ENA_SHIFT, 0,
			arizona_slim_tx_ev,
			SND_SOC_DAPM_POST_PMU | SND_SOC_DAPM_PRE_PMD),
SND_SOC_DAPM_AIF_IN_E("SLIMTX4", NULL, 0,
			ARIZONA_SLIMBUS_TX_CHANNEL_ENABLE,
			ARIZONA_SLIMTX4_ENA_SHIFT, 0,
			arizona_slim_tx_ev,
			SND_SOC_DAPM_POST_PMU | SND_SOC_DAPM_PRE_PMD),
SND_SOC_DAPM_AIF_IN_E("SLIMTX5", NULL, 0,
			ARIZONA_SLIMBUS_TX_CHANNEL_ENABLE,
			ARIZONA_SLIMTX5_ENA_SHIFT, 0,
			arizona_slim_tx_ev,
			SND_SOC_DAPM_POST_PMU | SND_SOC_DAPM_PRE_PMD),
SND_SOC_DAPM_AIF_IN_E("SLIMTX6", NULL, 0,
			ARIZONA_SLIMBUS_TX_CHANNEL_ENABLE,
			ARIZONA_SLIMTX6_ENA_SHIFT, 0,
			arizona_slim_tx_ev,
			SND_SOC_DAPM_POST_PMU | SND_SOC_DAPM_PRE_PMD),
SND_SOC_DAPM_AIF_IN_E("SLIMTX7", NULL, 0,
			ARIZONA_SLIMBUS_TX_CHANNEL_ENABLE,
			ARIZONA_SLIMTX7_ENA_SHIFT, 0,
			arizona_slim_tx_ev,
			SND_SOC_DAPM_POST_PMU | SND_SOC_DAPM_PRE_PMD),
SND_SOC_DAPM_AIF_IN_E("SLIMTX8", NULL, 0,
			ARIZONA_SLIMBUS_TX_CHANNEL_ENABLE,
